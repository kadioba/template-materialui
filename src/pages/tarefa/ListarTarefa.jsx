...
const ListarTarefa = () => {
  ...
  return(
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      <StyledCard>
        <StyledCardHeader
          title={<Typography variant="h5">Tarefas</Typography>}
          subheader={<Typography variant="subtitle1" color="inherit">Listagem de Tarefas</Typography>}
        /> 
        <CardContent>
                ...
                {tarefas.map((row, indice) => (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <StyledButton variant="contained" color="primary" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></StyledButton>            
                    </TableCell>
                    <TableCell align="center">
                      <StyledButton variant="contained" color="error" onClick={() => handleDeletar(row.idTarefa)}><DeleteIcon fontSize="small" /></StyledButton>            
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
